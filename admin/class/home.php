...
$html -> init();
	...
	$html -> jscript('./../resource/jscript/function-home.js?v=1.12');
...
$html -> endInit();
	...
	if($index == 0){
		...
		echo Temp:: form_logo();
		echo Temp:: form_banner();
		echo Temp:: form_short();
		echo Temp:: form_institutions();
		echo Temp:: form_certification();
		echo Temp:: form_location();
		
		echo Temp:: content_home($username);
	}
