...
$html -> init();
	...
	$html -> jscript('./../resource/jscript/function-course.js?v=1.16');
...
$html -> endInit();
	...
	if($index == 0){
		...
		echo Temp:: form_course();
		echo Temp:: form_url();
		echo Temp:: form_showlesson();
		echo Temp:: form_lesson();
		
		echo Temp:: content_coursed($username);
	}
