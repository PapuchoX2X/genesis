...
<body>
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
							...
							if($personname == ''){
								...
								<a href="registerc.php" class="nav-item nav-link active">Registrar</a>
								<a href="contactd.php" class="nav-item nav-link">Contacto</a>
								';
							}
							?>
                        </div>
        ...
        <div class="row px-xl-5">
            <div class="col-12">
                <nav class="breadcrumb bg-light mb-30">
                    ...
                    <span class="breadcrumb-item active" style="color:#fff;">Registrar Curso</span>
                </nav>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid">
        <div class="row px-xl-5">
            <div class="col-lg-8">
                <h5 class="section-title position-relative text-uppercase mb-3"><span class="bg-secondary pr-3">Registra Tu Curso</span></h5>
                <div class="bg-light p-30 mb-5">
                    <div class="row">
						
						<p>Registra el nombre y descripcion del curso que deseas impartir, El departamento economico se comunicara con usted</p>
                        <div class="col-md-6 form-group">
                            <label>Nombre Curso</label>
                            <input id="coursename" class="form-control" type="text" placeholder="Nombre Curso">
							<br>
							<label>Modalidad</label>
                            <select id="coursemode" class="custom-select">
                        ...
                        <div class="col-md-6 form-group">
							...
							<textarea id="coursedesc" class="form-control" id="comments" name="text" placeholder="Descripcion" rows="4"></textarea>
                        </div>
						
						<div class="col-md-6 form-group">
							<button id="btn_register_course" class="btn btn-block btn-primary font-weight-bold py-3" onclick="new_course()">Registrar</button>
						</div>
                ...
                <div class="collapse mb-5" id="shipping-address">
                    ...
                    <div class="bg-light p-30">
                        <div class="row">
                            <div class="col-md-6 form-group">
                                <label>Nombre Curso</label>
                                <input id="coursenames" class="form-control" type="text" placeholder="Nombre Curso">
								<br>
								<label>Modalidad</label>
								<select id="coursemodes" class="custom-select">
									<option selected>Virtual</option>
									<option>Presencial</option>
									<option>Mixta</option>
								</select>
                            ...
                            <div class="col-md-6 form-group">
                                <label>Descripcion</label>
								<textarea id="coursedescs" class="form-control" id="comments" name="text" placeholder="Descripcion" rows="4"></textarea>
                            </div>
                            
							<div class="col-md-6 form-group">
                                <button  id="btn_register_courses" class="btn btn-block btn-primary font-weight-bold py-3">Registrar</button>
                            </div>
            ...
            <div class="col-lg-8 table-responsive mb-5">
                <table class="table table-light table-borderless table-hover text-center mb-0">
                    ...
                    <tbody class="align-middle"  id="table_cart">
						...
						$total = 0;
						$cont = 0;
						$sql = "select * from detail where codeperson = '$codeperson' order by codedetail asc";
						...
						{  	 	 	 	 	 	 	 	 	 	 	 	
							...
							echo"
								<tr>
									<td class='align-middle'>".wordwrap($detailcourse, 30, "<br />\n")."</td>
									<td class='align-middle'>$detailstate</td>
