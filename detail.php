                ...
                <div class="h-100 bg-light p-30">
                    ...
                    <div class="d-flex align-items-center mb-4 pt-2">
						...
						if(!db_exist("select * from detail where codecourse = '$codecourse' and codeperson = '$codeperson'")){
							echo "<button class='btn btn-primary px-3' onclick='add_course($codecourse)'> <i class='fa fa-hopping-cart fa-lg'></i> Comprar</button>";
							...
							<div class='product-img position-relative overflow-hidden' onclick='ref_detail($codecourse)' style='cursor: pointer;'>
								...
								<div class='product-action'>
									<div class='img-text' href='#' style='color:red;'>
										...
										<p style='font-size:12px;color:#000000;margin-top:-30px;text-align: justify;'>$descc</p>
