...
$_SESSION [ 'codeperson' ] = $codeperson ; 
	...
	$codesubcategoryget = $_GET['codesubcategory'];
	
	$row_cat = db_fetch_array (db_query("select subcategoryname from subcategory where codesubcategory = '$codesubcategoryget'"));
	list ($subcategorynameget) = $row_cat;
...
<body>
    ...
    <div class="container-fluid pt-5 pb-3">
        <h2 class="section-title position-relative text-uppercase mx-xl-5 mb-4"><span class="bg-secondary pr-3"><?php echo $subcategorynameget; ?></span></h2>
        <div class="row px-xl-5">
			<?php
			$contc = 0;
			$query_course = "select * from course where codesubcategory = '$codesubcategoryget' order by rand() limit 8";
