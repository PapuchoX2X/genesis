...
$_SESSION [ 'codeperson' ] = $codeperson ; 
	...
	$row_cat = db_fetch_array (db_query("select categoryname from category where codecategory = '$codecategory'"));
	list ($categoryname) = $row_cat;
...
<body>
						...
						{ 	 	 	 	 	 	 	 	 	 	 	 	
							...
							if(db_exist("select * from subcategory where codecategory = '$codecategory'")){
								...
								<div class='nav-item dropdown dropright'>
									...
									$contt = 0;
									$query_subcategory = "select * from subcategory where codecategory = '$codecategory' order by subcategory asc";
									...
									{ 	 	 	 	 	 	 	 	 	 	 	 	
										...
										echo"<a href='subcategory.php?codesubcategory=$codecourse' class='dropdown-item'>$subcategoryname</a>";
    ...
    <div class="container-fluid pt-5 pb-3">
        <h2 class="section-title position-relative text-uppercase mx-xl-5 mb-4"><span class="bg-secondary pr-3"><?php echo $categoryname; ?></span></h2>
        <div class="row px-xl-5">
			<?php
			$contc = 0;
			$query_course = "select * from course where codesubcategory = '$codecategory' order by rand() limit 8";
			...
			{ 	 	 	 	 	 	 	 	 	 	 	 	
				...
				echo"
				<div class='col-lg-3 col-md-4 col-sm-6 pb-1' data-toggle='tooltip' title='Disabled tooltip'>
    ...
    <div class="container-fluid pt-5 pb-3">
        ...
        <div class="row px-xl-5">
			<?php
			$contc = 0;
			$query_course = "select * from course where codecategory != '1' order by rand() limit 8";
			$result_course=db_query($query_course);
			while($row_course = mysqli_fetch_array($result_course))
			{ 	 	 	 	 	 	 	 	 	 	 	 	
				$contc++;		 	 	 	 	 	 	 	 	 	 	 	 	 	 	 	 	
