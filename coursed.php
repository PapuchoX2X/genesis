...
<body>
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
							...
							if($personname == ''){
								...
								echo'
								<a href="coursed.php" class="nav-item nav-link active">Mis Cursos</a>
    ...
    <div class="container-fluid pt-5 pb-3">
        ...
        <div class="row px-xl-5">
			<?php
			$contd = 0;
			$query_detail = "select * from detail where codeperson = '$codeperson' and detailstate = 'FINALIZADO' order by rand() limit 8";
			...
			{ 	 	 	 	 	 	 	 	 	 	 	 	
				...
				$row_course = db_fetch_array (db_query("select coursename, courseprice, coursestar, courseimg from course where codecourse = '$codecourse'"));
				list ($coursename, $courseprice, $coursestar, $courseimg) = $row_course;
				...
				<div class='col-lg-3 col-md-4 col-sm-6 pb-1'>
					<div class='product-item bg-light mb-4'>
						...
						<div class='text-center py-4'>
							<a class='h6 text-decoration-none text-truncate' href='detaild.php?codecourse=$codecourse'>".wordwrap($coursename, 25, "<br />\n")."</a>
