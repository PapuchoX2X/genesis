            ...
            <div class="col-lg-7 h-auto mb-30">
                <div class="h-100 bg-light p-30">
                    ...
                    <div class="d-flex align-items-center mb-4 pt-2">
                        ...
                        <?php //echo "<button class='btn btn-primary px-3' onclick='add_course($codecourse)'> <i class='fa fa-hopping-cart mr-1'></i> Comprar</button>";?>
                    </div>
            ...
            <div class="col">
                <div class="bg-light p-30">
                    <div class="nav nav-tabs mb-4">
                        ...
                        <a class="nav-item nav-link text-dark" data-toggle="tab" href="#tab-pane-2" >Clases</a>
                    </div>
