        ...
        <div class="row px-xl-5">
            <div class="col-12">
                <nav class="breadcrumb bg-light mb-30">
                    ...
                    <a class="breadcrumb-item text-primary" href="shop.php">Curso</a>
                    <span class="breadcrumb-item active" style="color:#fff;">Iniciar Sesión</span>
                </nav>
            </div>
        </div>
    </div>
                ...
                <div class="bg-light p-30 mb-5">
                    <div class="row">
                        ...
                        <div class="col-md-6 form-group">
							...
							<div class="input-group">
								<input id="personpassword" class="form-control" type="password" placeholder="Contraseña">
								<div class="input-group-append">
                        ...
                        <div class="col-md-6 form-group">
							<button id="btn_login" class="btn btn-block btn-primary font-weight-bold py-3">Iniciar Sesión</button>
						</div>
						<div class="col-md-6 form-group">
							<br/>
							<a class="text-white" href="recover.php"> <span class="bg-secondary pr-3">Olvidaste tu Contraseña</span> </a>
						</div>
                    </div>
                </div>
                <div class="collapse mb-5" id="shipping-address">
                    ...
                    <div class="bg-light p-30">
                        <div class="row">
                            <div class="col-md-6 form-group">
                                <label>Correo Electronico</label>
                                <input id="personmails" class="form-control" type="text" placeholder="example@email.com">
                            </div>
                            <div class="col-md-6 form-group">
                                <label>Contraseña</label>
                                <input id="personpasswords" class="form-control" type="password" placeholder="Contraseña">
                            </div>
							<div class="col-md-6 form-group">
                                <button id="btn_logins" class="btn btn-block btn-primary font-weight-bold py-3">Iniciar Sesión</button>
                            </div>
							<div class="col-md-6 form-group">
								<br/>
								<a class="text-white" href="recover.php"> <span class="bg-secondary pr-3">Olvidaste tu Contraseña</span> </a>
