...
list ($personname) = $row_person;
	...
	$row_mision = db_fetch_array (db_query("select aboutdesc, aboutimg from about where codeabout = '1'"));
	list ($aboutdescm, $aboutimgm) = $row_mision;

	$row_vision = db_fetch_array (db_query("select aboutdesc, aboutimg from about where codeabout = '2'"));
	list ($aboutdescv, $aboutimgv) = $row_vision;
							...
							if(db_exist("select * from subcategory where codecategory = '$codecategoryd'")){
								...
								<div class='nav-item dropdown dropright'>
									...
									{ 	 	 	 	 	 	 	 	 	 	 	 	
										...
										echo"<a href='subcategory.php?codesubcategory=$codesubcategoryd' class='dropdown-item'>$subcategorynamed</a>";
        ...
        <div class="row px-xl-5">
            <div class="col-12">
                <nav class="breadcrumb bg-light mb-30">
                    ...
                    <span class="breadcrumb-item active" style="color:#fff;">Acerca De Nosotros</span>
                </nav>
            </div>
        </div>
    </div>
        ...
        <div class="row px-xl-5">
                ...
                <div id="product-carousel" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner bg-light">
                        <div class="carousel-item active">
                            <?php echo"<img class='w-100 h-100' src='admin/resource/images/$aboutimgm' alt='Image'>";?>
                        </div>
            ...
            <div class="col-lg-7 h-auto mb-30">
                <div class="h-100 bg-light p-30">
                    ...
                    <p class="mb-4"><?php echo $aboutdescm;?></p>
		...
		<div class="row px-xl-5">
            <div class="col-lg-7 h-auto mb-30">
                <div class="h-100 bg-light p-30">
                    ...
                    <p class="mb-4"><?php echo $aboutdescv;?></p>
			...
			<div class="col-lg-5 mb-30">
                <div id="product-carousel" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner bg-light">
                        <div class="carousel-item active">
                            <?php echo"<img class='w-100 h-100' src='admin/resource/images/$aboutimgv' alt='Image'>";?>
                        </div>
