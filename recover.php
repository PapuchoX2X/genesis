...
<body>
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
							...
							if($personname == ''){
								...
								echo'
								<a href="validate.php" class="nav-item nav-link">Validar</a>
								<!--<a href="about.php" class="nav-item nav-link">Acerca De</a>
								<a href="shop.php" class="nav-item nav-link">Cursos</a>
								<a href="course.php" class="nav-item nav-link">Mis Cursos</a>
								<a href="contact.php" class="nav-item nav-link">Contacto</a>-->
        ...
        <div class="row px-xl-5">
            <div class="col-12">
                <nav class="breadcrumb bg-light mb-30">
                    <a class="breadcrumb-item text-primary" href="index.php">Iniciar Sesión</a>
                    <!--<a class="breadcrumb-item text-dark" href="#">Curso</a>-->
                    <span class="breadcrumb-item active" style="color:#fff;">Recuperar Contraseña</span>
                </nav>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid">
        <div class="row px-xl-5">
            <div class="col-lg-8">
                <h5 class="section-title position-relative text-uppercase mb-3"><span class="bg-secondary pr-3">Recuperar Contraseña</span></h5>
                <div class="bg-light p-30 mb-5">
                    <div class="row">
						<p> Se le enviara a su correo electronico su Contraseña </p>
					</div>
                    <div class="row">
                        <div class="col-md-6 form-group">
                            <label>Correo Electronico</label>
                            <input id="personmail" class="form-control" type="text" placeholder="Correo Electronico">
                        </div>
                        
						<div class="col-md-6 form-group">
							<label> </label>
							<button id="btn_recover" code="<? echo $codeperson;?>" class="btn btn-block btn-primary font-weight-bold py-3">Enviar</button>
						</div>
                ...
                <div class="collapse mb-5" id="shipping-address">
                    ...
                    <div class="bg-light p-30">
                        <div class="row">
                            <div class="col-md-6 form-group">
                                <label>Correo Electronico</label>
                                <input id="personmails" class="form-control" type="text" placeholder="Correo Electronico">
                            </div>
                            
							<div class="col-md-6 form-group">
                                <button id="btn_recovers" class="btn btn-block btn-primary font-weight-bold py-3">Enviar</button>
                            </div>
