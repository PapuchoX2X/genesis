...
<body>
        ...
        <div class="row px-xl-5">
            <div class="col-12">
                <nav class="breadcrumb bg-light mb-30">
                    <a class="breadcrumb-item text-primary" href="register.php">Registro</a>
                    <span class="breadcrumb-item active" style="color:#fff;">Validar Cuenta</span>
                </nav>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid">
        <div class="row px-xl-5">
            <div class="col-lg-8">
                <h5 class="section-title position-relative text-uppercase mb-3"><span class="bg-secondary pr-3">Validar Cuenta</span></h5>
                <div class="bg-light p-30 mb-5">
                    <div class="row">
						<p> Introdusca el codigo que se le envio a su correo electronico, para validar su cuenta </p>
					</div>
                    <div class="row">
                        <div class="col-md-6 form-group">
                            <label>Codigo</label>
                            <input id="personcode" class="form-control" type="text" placeholder="Codigo">
                        </div>
                        
						<div class="col-md-6 form-group">
							<label> </label>
							<button id="btn_validate" code="<? echo $codeperson;?>" class="btn btn-block btn-primary font-weight-bold py-3">Enviar</button>
						</div>
                ...
                <div class="collapse mb-5" id="shipping-address">
                    ...
                    <div class="bg-light p-30">
                        <div class="row">
							...
							<div class="col-md-6 form-group">
                                <button class="btn btn-block btn-primary font-weight-bold py-3">Enviar</button>
                            </div>
