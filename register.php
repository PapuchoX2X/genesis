...
<body>
        ...
        <div class="row px-xl-5">
            <div class="col-12">
                <nav class="breadcrumb bg-light mb-30">
                    ...
                    <span class="breadcrumb-item active" style="color:#fff;">Registro</span>
                </nav>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid">
        <div class="row px-xl-5">
            <div class="col-lg-8">
                <h5 class="section-title position-relative text-uppercase mb-3"><span class="bg-secondary pr-3">Registrate</span></h5>
                <div class="bg-light p-30 mb-5">
                    <div class="row">
                        <div class="col-md-6 form-group">
                            <label>Nombre Completo</label>
                            <input id="personname" class="form-control" type="text" placeholder="Nombre Completo">
                        </div>
                        <div class="col-md-6 form-group">
                            <label>Telefono/Celular</label>
                            <input id="personphone" class="form-control" type="text" placeholder="Telefono - Celular">
                        </div>
                        <div class="col-md-6 form-group">
                            <label>Correo Electronico</label>
                            <input id="personmail" class="form-control" type="text" placeholder="example@email.com">
                        </div>
                        <div class="col-md-6 form-group">
                            <label>Contraseña</label>
                            <input id="personpassword" class="form-control" type="text" placeholder="Contraseña">
                        </div>
                        <div class="col-md-6 form-group">
                            <label>Tipo</label>
                            <select id="persontype" class="custom-select">
                                <option selected>Estudiante</option>
                                <option>Docente</option>
                            </select>
                        </div>
						<div class="col-md-6 form-group">
							<button id="btn_register" class="btn btn-block btn-primary font-weight-bold py-3">Registrar</button>
						</div>
                ...
                <div class="collapse mb-5" id="shipping-address">
                    ...
                    <div class="bg-light p-30">
                        <div class="row">
                            ...
                            <div class="col-md-6 form-group">
                                <label>Telefono/Celular</label>
                                <input class="form-control" type="text" placeholder="Telefono - Celular">
                            </div>
                            <div class="col-md-6 form-group">
                                <label>Correo Electronico</label>
							...
							<div class="col-md-6 form-group">
                                <button class="btn btn-block btn-primary font-weight-bold py-3">Registrar</button>
                            </div>
